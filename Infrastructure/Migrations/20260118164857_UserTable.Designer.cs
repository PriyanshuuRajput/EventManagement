...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260118164857_UserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.RealUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Entities.Event", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.EventCategory", "EventCategory")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Domains.Entities.RealUser", b =>
                {
                    b.HasOne("Domains.Entities.AdminUser", "User")
                        .WithOne("RealUser")
                        .HasForeignKey("Domains.Entities.RealUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
